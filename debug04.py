...
sc1 = ax1.scatter(points[:, 0], points[:, 1],
...
ax1.set_ylabel("Y (forward)", fontsize=9)
ax1.set_xlim(-10, 10)
ax1.set_ylim(-3, 5)
...
sc2 = ax2.scatter(non_ground_pts[:, 0], non_ground_pts[:, 1],
                  c=non_ground_pts[:, 2], cmap="plasma", s=2, vmin=0, vmax=30)
ax2.set_title("Non-ground 2D Points (colored by Depth)", fontsize=10)
ax2.set_xlabel("X (right)", fontsize=9)
ax2.set_ylabel("Y (forward)", fontsize=9)
ax2.set_xlim(-10, 10)
ax2.set_ylim(-3, 5)
